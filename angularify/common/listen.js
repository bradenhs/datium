...
(function (listen) {
    ...
    function mousemove(element, callback) {
        return attachEvents(['mousemove'], element, function (e) {
            callback(e);
        });
    }
    ...
    function touchstart(element, callback) {
        return attachEvents(['touchstart'], element, function (e) {
            callback(e);
        });
    }
    listen.touchstart = touchstart;
    function touchend(element, callback) {
        return attachEvents(['touchend'], element, function (e) {
            callback(e);
        });
    }
    ...
    function updateDefinedState(element, callback) {
        return attachEvents(['datium-update-defined-state'], element, function (e) {
            callback(e.detail);
        });
    }
    listen.updateDefinedState = updateDefinedState;
