...
var YearPicker = (function (_super) {
    ...
    YearPicker.prototype.create = function (date, transition) {
        var minYear = Math.floor(date.getFullYear() / 10) * 10;
        this.min = new Date(minYear, 0);
        this.min.setFullYear(minYear);
        var maxYear = Math.ceil(date.getFullYear() / 10) * 10;
    ...
    YearPicker.prototype.setValid = function () {
        ...
        for (var i = 0; i < yearElements.length; i++) {
            ...
            var next = new Date(date.getFullYear() + 1, 0);
